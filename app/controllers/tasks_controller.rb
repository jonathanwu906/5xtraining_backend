...
class TasksController < ApplicationController
  ...
  def create
    ...
    if @task.save
      flash[:notice] = '成功建立任務！' # rubocop:disable Rails/I18nLocaleTexts
  ...
  def update
    if @task.update(task_params)
      flash[:notice] = '成功更新任務！' # rubocop:disable Rails/I18nLocaleTexts
      redirect_to action: :show, id: @task.id
    else
  ...
  def destroy
    ...
    @task.destroy
    flash[:notice] = '成功刪除任務！' # rubocop:disable Rails/I18nLocaleTexts
